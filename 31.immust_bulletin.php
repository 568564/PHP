<html>
    ...
    <meta charset="utf-8"><!--設為 UTF-8 編碼，避免亂碼-->
    <!--引入 jQuery 與 FlexSlider：輪播圖用的套件-->
    ...
    <style>
        *{
        ...
        .top .container{
            display: flex;/* 使用 Flex 排版，讓內部元素橫向排列 */
        ...
        .dropdown:hover .dropdown-content {
            display: block;   /*顯示區塊元素列讓選單垂直排列*/

        }
        li.dropdown:hover{
            background-color: #333;  /*改變背景顏色*/
        }
        .dropdown-content {  /*設定下拉選單內容格式 設定絕對位置*/
            display: none;
            position: absolute;
            background-color: #333;
            min-width: 160px;/*設定選單寬度*/
            z-index: 1;/*設定圖層順序*/
        }
        ...
        <div class="top">
            <div class="container">
                ...
                <div class="top-nav">
                  ...
                  <label onclick="document.getElementById('login').style.display='block'">登入</label> <!-- 點擊文字後跳出登入視窗 -->
                  <div id="login" class="modal"><!--登入對話框-->
                    <span onclick="document.getElementById('login').style.display='none'">&times; 管理系統登入</span>
                     <!-- 登入表單，POST 到 10.login.php -->
